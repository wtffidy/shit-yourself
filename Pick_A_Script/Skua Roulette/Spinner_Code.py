...
def run_spinner():
    ...
    running = True
    nonlocal_vars = {"rotation": rotation, "spin_speed": spin_speed,
                     "spinning": spinning, "selected_index": selected_index}

    # Because rotation and spin_speed need to be updated inside event loop, we'll use a trick
    rotation = 0
    spin_speed = 0
    spinning = False
    selected_index = None
